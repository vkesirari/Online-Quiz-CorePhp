...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-left">
                    ...
                    <li><a href="dashboard.php?q=5">Remove Quiz | Update Quiz</a></li>
                </ul>
                ...
                <?php 
                    if(@$_GET['q']==1) 
                    {
                        ...
                        while($row = mysqli_fetch_array($result)) 
                        {
                            ...
                            $email = $row['email'];
                            $college = $row['college'];
                            echo '<tr><td><center>'.$c++.'</center></td><td><center>'.$name.'</center></td><td><center>'.$college.'</center></td><td><center>'.$email.'</center></td><td><center>
                ...
                <?php 
                    if(@$_GET['q']==5) 
                    {
                        ...
                        while($row = mysqli_fetch_array($result)) {
                            ...
                            <td><center><b><a href="update.php?q=rmquiz&eid='.$eid.'" class="pull-right btn sub1" style="margin:0px;background:red;color:black"><span class="glyphicon glyphicon-trash" aria-hidden="true">
                            </span>&nbsp;<span class="title1"><b>Remove</b></span></a></b></center></td>
                            
                            <td><center><b><a href="dashboard.php?q=4&step=2&eid='.$eid.'&n='.$total.'" class="btn sub1" style="color:black;margin:0px;background:#1de9b6"><span class="glyphicon glyphicon-new-window" aria-hidden="true"></span>&nbsp;<span class="title1">
                            <b>Edit</b></span></a></b></center></td>
                            </tr>';
                        }
                        $c=0;
                        echo '</table></div></div>';
    ...
    <!-- <footer>
        <hr>
        <p>Developer: Vikramjeet Singh</p>
        <p class="email">Email: Vikkysirari143@gmail.com</p>
    </footer> -->
</body>
</html>
